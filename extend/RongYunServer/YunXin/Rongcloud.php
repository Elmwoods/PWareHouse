 ...
 * v2.0.1
 */
namespace RongYunServer\YunXin;
use RongYunServer\User;
use RongYunServer\Message;
use RongYunServer\Sensitiveword;
use RongYunServer\Group;
use RongYunServer\Chatroom;
use RongYunServer\Push;
use RongYunServer\SMS;
class Rongcloud
{
    private $SendRequest;
    /**
    ...
    public function Wordfilter() {
        $Wordfilter = new Sensitiveword($this->SendRequest);
        return $Wordfilter;
    }
