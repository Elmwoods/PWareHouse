...
{
    private $RongCloud;
    private $appKey='p5tvi9dsp4v14';
    private $appSecret='ySJHJumM2i';
   ...
   /**
    ...
    public function removeBlacklists($userId,$blackUserId){
        ...
        $info = $this->RongCloud->user()->removeBlacklist($uid,$blackuid);
        return $info;
    }
    /*--------------------------消息处理---------------------------*/
    /**
   ...
   /**
     ...
     * @return $json
     **/
    public function publishGroups($fromUserId,$toGroupId,$objectName,$content,$pushContent,$pushData,$isPersisted,$isCounted,$isIncludeSender){
