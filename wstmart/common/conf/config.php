...
return [
    ...
    // 扩展函数文件
    'extra_file_list'        => [THINK_PATH.'helper'.EXT,WST_COMM."function.php",WST_HOME_COMM."function.php",WST_ADMIN_COMM."function.php",WST_WECHAT_COMM."function.php"],
    // 默认输出类型
    ...
    'view_replace_str'       => [
        ...
        '__VVADMIN__'=>str_replace('/index.php','',\think\Request::instance()->root()).'/public/vvadmin',
        '__VVV__'=>str_replace('/index.php','',\think\Request::instance()->root()).'/public',
        '__VVOFF__'=>str_replace('/index.php','',\think\Request::instance()->root()).'/public/vvoff'
    ],
    // 默认跳转页面对应的模板文件
