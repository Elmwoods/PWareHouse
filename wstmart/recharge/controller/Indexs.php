...
// header('Content-Type: text/html; charset=UTF-8');
	...
	public function asynchronous(){
		...
		// echo 'success';
		// 192.168.0.50/wstmart/recharge/index/asynchronous
		$flag='http://www.jingomall.com/purse/callback/receive?total_amount=0.01&buyer_id=2088702766099563&body=我是测试数据&trade_no=2017061721001004560223640065¬ify_time=2017-06-17 09:41:51&subject=钱袋充值&sign_type=RSA2&buyer_logon_id=yyy***@163.com&auth_app_id=2017011705151664&charset=UTF-8¬ify_type=trade_status_sync&invoice_amount=0.01&out_trade_no=2017061701160660529&trade_status=TRADE_SUCCESS&gmt_payment=2017-06-17 09:16:16&version=1.0&point_amount=0.00&sign=$$$&gmt_create=2017-06-17 09:16:16&buyer_pay_amount=0.01&receipt_amount=0.01&fund_bill_list=[{"amount":"0.01","fundChannel":"ALIPAYACCOUNT"}]&app_id=2017011705151664&seller_id=2088521576735526¬ify_id=f247f658626804894af7b0d0c04142dkbm&seller_email=$$$&';
		// dump(url_decode($flag));
		$arr 	=	parse_url($flag);
		// var_dump($arr);die;
		...
		// 	if($qd && $qd['pdr_amount']==$params['invoice_amount']){
		// 		//修改钱袋流水表信息	
		...
		// 	if($jd && $jd['imr_amount']==$params['invoice_amount']){
		// 		//修改信息
		...
		// 	if($hy && $hy['al_amonut']==$params['invoice_amount']){
		// 		//修改al_amount参数
