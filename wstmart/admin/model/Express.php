...
class Express extends Base{
	...
	public function add(){
		...
		$result = $this->validate('Express.add')->allowField(['expressName','expressCode'])->save($data);
        if(false !== $result){
	...
	public function edit(){
	    ...
	    $result = $this->validate('Express.edit')->allowField(['expressName','expressCode'])->save(['expressName'=>input('post.expressName'),'expressCode'=>input('post.expressCode')],['expressId'=>$expressId]);
