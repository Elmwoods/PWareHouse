...
WST.inLogin = function(){
	...
	var url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='+window.conf.wxAppId+'&redirect_uri='+urls+'&response_type=code&scope=snsapi_userinfo&state='+window.conf.wxAppCode+'#wechat_redirect';
...
WST.search = function(type){
	...
	if(type==1){
		...
		location.href = WST.U('wechat/shops/home','goodsName='+data+'&shopId='+shopId);//店铺商品
	}
};
//关注
