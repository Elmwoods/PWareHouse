...
class Users extends Base{
	...
	public function pageQuery(){
		...
		$rs = $this->alias('u')->join('__SHOPS__ s','u.userId=s.userId and s.dataFlag=1','left')->where($where)
					->field(['u.userId','loginName','userName','userType','userPhone','userEmail','userScore','u.createTime','userStatus','lastTime','s.shopId'])
					->order('u.userId desc')
	...
	public function edit(){
		...
		try{
			...
			WSTUnset($data,'createTime,userId,loginName');
