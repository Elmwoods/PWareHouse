   ...
   <?php if(!empty($goodsPage["Rows"])): ?>
	<div class='goods-side'>
		<div class="guess-like">
			...
			<?php $wstTagGoods =  model("common/Tags")->listGoods("best",0,3,0); foreach($wstTagGoods as $key=>$vo){?>
			<div class="item">
