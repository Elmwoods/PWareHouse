<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"/mnt/data/www/wstmart/mobile/view/default/login.html";i:1491530392;s:51:"/mnt/data/www/wstmart/mobile/view/default/base.html";i:1491530392;}*/ ?>
<html>
<head>
<meta charset="utf-8">
...
<body ontouchstart="">
      ...
      <section class="ui-container" id="login1">
		...
		<ul class="ui-row">
		    <li class="ui-col ui-col-50"><a href="<?php echo url('mobile/users/toRegister'); ?>" class="button0">注册新账号</a></li>
		    <li class="ui-col ui-col-50 forget"><a href="<?php echo url('mobile/users/forgetpass'); ?>" class="button0">忘记密码</a></li>
		</ul>
