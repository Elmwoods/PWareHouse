...
<div class="bc-nav">
	<p>
		...
		<a href="#">> 客服中心</a>
		<?php if(is_array($bcNav) || $bcNav instanceof \think\Collection): $i = 0; $__LIST__ = $bcNav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bc): $mod = ($i % 2 );++$i;if(($bc['catId']!=7)): ?>
...
<div class="help-box">
	<div class="help-left">
		...
		<ul id="parent">
			<?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;$cat=explode('-',$key);?>
            <li class="h-cat <?php if(($cat[1]==$data['catId'])): ?>h-show<?php else: ?>h-hide<?php endif; ?>">
                <span><?php echo $cat[0]; ?><p></p></span>
                <ul class="h-list">
                	<?php if(is_array($v) || $v instanceof \think\Collection): $k1 = 0; $__LIST__ = $v;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($k1 % 2 );++$k1;?>
