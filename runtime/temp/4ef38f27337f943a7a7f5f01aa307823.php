<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"/mnt/data/www/wstmart/vvadmin/view/staff/enadd.html";i:1495100098;s:51:"/mnt/data/www/wstmart/vvadmin/view/index/index.html";i:1495716001;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="mainbar">
				...
				<!-- Page heading -->
				<div class="page-head">
					<h2 class="pull-left"><i class="icon-list-alt"></i>职员添加(英文版)</h2>

					<!-- Breadcrumb -->
					<div class="bread-crumb pull-right">
						<a href="<?php echo url('Staff/doenlist'); ?>"><i class="icon-list-alt"></i>职员列表(英文版)</a>
						<!-- Divider -->
						<span class="divider">/</span>
						<a href="#" class="bread-current">职员添加(英文版)</a>
					</div>
            ...
            <div class="col-md-12">
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-head" style="padding: 8px 15px;">
                  <div class="pull-left">职员添加(英文版)</div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal"  action="<?php echo url('Staff/endoadd'); ?>" method="post" id="enstaffadd" enctype="multipart/form-data">

                                <div class="form-group">
                                  <label class="col-lg-4 control-label">姓名</label>
                                  <div class="col-lg-8">
                                    <input class="form-control" placeholder="" type="text" name="e_name">
                                  </div>
                                </div>                           
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">部门职务</label>
                                  <div class="col-lg-8">
                                    <input class="form-control" placeholder="" type="text" name="e_job" >
                                  </div>
                                 </div>
                                 <div class="form-group">
                                  <label class="col-lg-4 control-label">格言</label>
                                  <div class="col-lg-8">
                                    <input class="form-control" placeholder="" type="text" name="e_motto">
                                  </div>
                                 </div>
                                 <div class="form-group">
                                  <label class="col-lg-4 control-label">个人简介</label>
                                  <div class="col-lg-8">
                                    <textarea  name="e_introduction" id="introduction" cols="135" rows="10"></textarea>
                                  </div>
                                 </div>
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">职员头像</label>
                                  <div class="col-lg-6">
                                    <input class="form-control" type="file" name="e_headimg">
                                  </div>
			<div class="col-lg-2">
