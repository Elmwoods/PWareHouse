<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:57:"/mnt/data/www/wstmart/home/view/default/goods_detail.html";i:1493786574;s:49:"/mnt/data/www/wstmart/home/view/default/base.html";i:1490282008;s:55:"/mnt/data/www/wstmart/home/view/default/header_top.html";i:1489733602;s:55:"/mnt/data/www/wstmart/home/view/default/shop_apply.html";i:1489135872;s:51:"/mnt/data/www/wstmart/home/view/default/header.html";i:1490953514;s:55:"/mnt/data/www/wstmart/home/view/default/right_cart.html";i:1490282866;s:51:"/mnt/data/www/wstmart/home/view/default/footer.html";i:1489648028;}*/ ?>
<!doctype html>
<head>
   ...
   <div class='wst-container' style='border:1px solid #eee'>
      ...
      <div class='intro'>
          ...
          <div class='summary'>
             ...
             <div class='goods-intro-bg'>
               <div class='item'>
                 ...
                 <div class='dd'>
          		    <?php $__FOR_START_757416151__=0;$__FOR_END_757416151__=$goods['scores']['totalScores'];for($i=$__FOR_START_757416151__;$i < $__FOR_END_757416151__;$i+=1){ ?>
          					<img src="__STATIC__/plugins/raty/img/star-on.png">
          				<?php } $__FOR_START_1399102948__=1;$__FOR_END_1399102948__=6-$goods['scores']['totalScores'];for($i=$__FOR_START_1399102948__;$i < $__FOR_END_1399102948__;$i+=1){ ?>
          					<img src="__STATIC__/plugins/raty/img/star-off.png">
          				<?php } ?>
          				<div class='appraise'>累计评价：<span class='appraise-num'><?php echo $goods['appraiseNum']; ?></span>（销量：<span class='appraise-num'><?php echo $goods['saleNum']; ?></span>）</div>
          				</div>
               </div>
               <div class='item'>
          ...
          <div class='spec'>
             ...
             <?php endforeach; endif; else: echo "" ;endif; elseif(($goods['isSpec'] == 2) AND (isset($goodsSpec))): ?>
              <style>
                  td {
                      padding: 5px;
                      width: 75px;
              ...
              <!--<div id="box">
                  <div> <span class="dt">颜色: </span><span id="color" class="dd"></span></div><br />
                  <div> <span class="dt">尺码：</span><span id="size" class="dd"></span></div>
              </div>-->
              ...
              <script type="text/javascript">
                  ...
                  $('#table_genre').find("tr").eq(0).find("td").eq(0).html("颜色:");
                  $('#table_genre').find("tr").eq(1).find("td").eq(0).html("尺寸:");
                  $('#table_genre').find("tr").eq(0).find("td").eq(0).css("margin","0 0 0 -12px");
                  $('#table_genre').find("tr").eq(1).find("td").eq(0).css("margin","0 0 0 -12px");
              </script>
             <?php endif; ?>
       ...
       <div class='wst-side'>
		   ...
		   <div class="goods-side">
				<div class="guess-like">
					...
					<div class="item">
						<div class="img"><a target='_blank' href="<?php echo Url('home/goods/detail','id='.$vo['goodsId']); ?>"><img title="<?php echo $vo['goodsName']; ?>" alt="<?php echo $vo['goodsName']; ?>" src="__ROOT__/<?php echo WSTImg($vo['goodsImg']); ?>"></a></div>
		...
		<div class='goods-desc'>
           ...
           <?php if(!$goods['read'] && $goods['goodsType']==0): ?>
