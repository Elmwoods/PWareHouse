<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"E:\wamp64\wamp\www\mall/wstmart/vvadmin\view\article\dolist.html";i:1495681660;s:61:"E:\wamp64\wamp\www\mall/wstmart/vvadmin\view\index\index.html";i:1495099634;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="mainbar">
				...
				<!-- Page heading -->
				<div class="page-head">
					<h2 class="pull-left"><i class="icon-list-alt"></i>文章管理</h2>

					<!-- Breadcrumb -->
					<div class="bread-crumb pull-right">
						<a href=""><i class="icon-list-alt"></i>文章列表</a>
						<!-- Divider -->
						<span class="divider">/</span>
						<a href="<?php echo url('add')?>" class="bread-current">添加文章</a>
					</div>
                  ...
                  <div class="padd">
                        <table class='table table-bordered table-hover' >
                             ...
                             <tr>
                                ...
                                <td><?php echo mb_substr($v['art_content'], 0, 240).'...';?></td>
                                <td><?php echo $v['art_img']?></td>
                                <td><?php echo $v['art_addtime']?></td>
                                <td><?php echo $v['art_from']?></td>
                                <td><?php echo $v['art_author']?></td>
                                <?php if($v['is_see']==1) echo '<td>是</td>';else  echo '<td>否</td>';?>
                                <td><a href="edit/id/<?php echo $v['id'];?>">修改</a><a onClick="return confirm('确定删除?');" href="delete/id/<?php echo $v['id'];?>">删除</a></td>
                             </tr>
                              <?php endforeach;?>
                        </table>
                  </div>
