<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"F:\wamp\www\jingo/wstmart/purse\view\default\gold_bean.html";i:1499417798;s:62:"F:\wamp\www\jingo/wstmart/purse\view\default\purse\header.html";i:1500261424;s:62:"F:\wamp\www\jingo/wstmart/purse\view\default\purse\bottom.html";i:1494837028;}*/ ?>
    ...
    <div class="nav_main ">
        <div class="nav_left">
            <ul>
                ...
                <li class="red"><a href="<?php echo url('imazamox/index'); ?>">我的金豆</a>|</li>
...
<div class="main">
    <div class="center public">
        <div class="main_main">
            <div class="main_left">
                我的金豆：<span><?php echo $users['imazamox_number']; ?></span>个
            </div>
        </div> 
    </div>
</div>			
    ...
    <div class="menu_main public">
        ...
        <table class="menu_table">
           ...
           <tr class="list">
            ...
            <?php if(is_array($im) || $im instanceof \think\Collection): $i = 0; $__LIST__ = $im;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr class="center">
                <td>
                ...
                <td>
                    <ul class="menu_select">
                            ...
                            <li><a href="javascript:WST.del_jd(<?php echo $vo['id']; ?>)">删除</a></li>
                        </ul>
                </td>
            </tr>
