<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"E:\wamp64\wamp\www\mall/wstmart/vvadmin\view\article\edit.html";i:1495011000;s:61:"E:\wamp64\wamp\www\mall/wstmart/vvadmin\view\index\index.html";i:1495099634;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="mainbar">
				...
				<!-- Page heading -->
				<div class="page-head">
					<h2 class="pull-left"><i class="icon-list-alt"></i>文章修改</h2>

					<!-- Breadcrumb -->
					<div class="bread-crumb pull-right">
						<a href="<?php echo url('Article/dolist'); ?>"><i class="icon-list-alt"></i>文章列表</a>
						<!-- Divider -->
						<span class="divider">/</span>
						<a href="#" class="bread-current">文章修改</a>
					</div>
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal"  action="<?php echo url('Article/doedit'); ?>" method="post" id="artedit" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $data['id']?>">
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">文章标题</label>
                                  <div class="col-lg-8">
                                    <input class="form-control" placeholder="" value="<?php echo $data['art_name']?>" type="text" name="art_name">
                                  </div>
                                </div>                               
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">文章内容</label>
                                  <div class="col-lg-8">
                                    <textarea  name="art_content" id="art_content" cols="132" rows="10">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input class="form-control" placeholder="" type="text" name="art_author" value="<?php echo $data['art_author']?>">
                                  </div>
                                 </div>
                                 <div class="form-group">
                                  <label class="col-lg-4 control-label">文章来源</label>
                                  <div class="col-lg-8">
                                    <input class="form-control" placeholder="" type="text" name="art_from" value="<?php echo $data['art_from']?>">
                                  </div>
                                 </div>
                                 <div class="form-group">
