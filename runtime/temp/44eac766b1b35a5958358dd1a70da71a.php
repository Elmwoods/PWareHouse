...
<div class="wst-container">
	<div class='goods-side'>
		<div class="guess-like">
			...
			<?php $wstTagGoods =  model("common/Tags")->listGoods("best",$catId,3,0); foreach($wstTagGoods as $key=>$vo){?>
			<div class="item">
