<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:69:"/mnt/data/www/wstmart/home/view/default/users/security/user_pass.html";i:1488332794;s:55:"/mnt/data/www/wstmart/home/view/default/users/base.html";i:1490953514;s:55:"/mnt/data/www/wstmart/home/view/default/header_top.html";i:1489733602;s:55:"/mnt/data/www/wstmart/home/view/default/shop_apply.html";i:1489135872;s:51:"/mnt/data/www/wstmart/home/view/default/footer.html";i:1489648028;}*/ ?>
<!doctype html>
<head>
...
<div class="wst-user-head"><span>设置密码</span><a href="<?php echo url('home/users/security'); ?>">返回</a></div>
	<form method="post" id="myorm" autocomplete="off">
        <table class='wst-form'>
        <?php if(($data['loginPwd'])): ?>
           <tr>
             <th align='right'> <font color='red'>*</font>原始密码：</th>
             <td>
             <input type='password' class="ipt" id='oldPass' name='oldPass' <?php if(($data['loginPwd'])): ?>data-rule="原始密码: required;" data-msg-required="请填写原始密码" data-tip="请输入原始密码"<?php endif; ?> style='width:250px;' maxLength='16'/>
             </td>
           </tr>
        <?php endif; ?>
           <tr>
