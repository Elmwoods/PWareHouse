<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"E:\wamp64\wamp\www\mall/wstmart/vvoff\view\index\index.html";i:1495704623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="header" id="15">
                    <img src="__VVOFF__/img/phone/A.png"/>
            ...
            <div class="swiper-slide">
                <div class="we" id="08">
                    ...
                    <br />
                    <span>“杭州京歌科技有限公司”率先在世界上掀起新一轮货币结算体系技术变革，利用现代网络模块化先进技术与分布式账本财务结算系统相结合，一改过去必须一手交钱、一手交货的传统观念，把“货”“币”自动分流，通过降低和减少商品流通、结算时间来增大社会能耗，进一步解放社会生产力。</span>
                    <br />
            ...
            <div class="swiper-slide">
                <div class="teams" id="13">
                    ...
                    <div class="teams_list">
                                        ...
                                        <div class="mteam_img">
                                            <dl>
                                                ...
                                                <dd>
                                                    <p>罗安华</p>
                                                    <br />
                                                    <p class="t_xt"> 公司执行董事 项目总设计师</p>
                                                    <br />
                                                    <span>“后现代金融”框架的提出者，和“币变”金融技术的提出者和研究者，也是“货币人均率”金融理论的研究者和倡导者。</span>
                                                </dd>
                                            </dl>
                                        </div>
                                    </a>
                                        ...
                                        <div class="mteam_img">
                                            <dl>
                                                ...
                                                <dd>
                                                    ...
                                                    <p class="t_xt">CTO</p>
                                                    <br />
                                                    <span>专注技术12年，2009年大学创业富豪榜49位，大学生创业榜样人物，2010年北京大学应邀专题开讲</span>
                                                </dd>
                                            </dl>
                                        </div>
                                    </a>
                                        ...
                                        <div class="mteam_img">
                                            <dl>
                                                ...
                                                <dd>
                                                    ...
                                                    <p class="t_xt">董事长</p>
                                                    <br />
                                                    <span>党员，《为货币辩护》作者，熟悉互联网金融，熟知企业管理</span>
                                                </dd>
                                            </dl>
                                        </div>
                                    </a>
                                        ...
                                        <div class="mteam_img">
                                            <dl>
                                                ...
                                                <dd>
                                                    <p>郑艳</p>
                                                    <br />
                                                    <p class="t_xt">新闻发言人</p>
                                                    <br />
                                                    <span>中级工程师研究学者，战略分析师，熟悉企业管理，在平面化设计和自动化设计专业领域出类拔萃</span>
                                                </dd>
                                            </dl>
                                        </div>
                                    </a>
                                        ...
                                        <div class="mteam_img">
                                            <dl>
                                                ...
                                                <dd>
                                                    <p>寇倩</p>
                                                    <br />
                                                    <p class="t_xt">人事行政主管</p>
                                                    <br />
                                                    <span>南开大学人力资源管理专业，熟悉人事行政工作，有丰富的经验，极强的学习力，创新意识和进取精神，努力让自己做到“无法复制”</span>
                                                </dd>
                                            </dl>
                                        </div>
                                    </a>
                        ...
                        <a href="team.html"><button>加载更多</button></a>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="newss" id="14">
                    <img src="img/0.png" class="new_img"/>
                    <div class="se_list">
                        <ul class="se_ul">
                            <a href="p_new1.html">
                                <li>
                                    <dl>
                                        ...
                                        <dd>
                                            <h2>人民币国际化受挫：SWIFT全球支付排名退居第六</h2>

                                            <span>人民币在国际化过程中受到一点小小的挫折。5月26日环球同业银行金融电讯协会（SWIFT）公布的数据显示，按照交易额计算，4月份人民币在国际支付货币的排名降至第六位，市场份额为1.82%。</span>
                                        </dd>
                                    </dl>
                                </li>
                            </a>
                            <a href="p_new2.html">
                                <li>
                                    <dl>
                                        ...
                                        <dd>
                                            <h2>谷歌测试语音支付 别急 中国支付技术早已应有尽有</h2>

                                            <span>谷歌最近真是火啊。一只阿尔法狗几乎让全球的目光都开始关注人工智能的发展。近日，谷歌又再次希望借助技术优势，在觊觎已久的支付市场搏出一番天地。即传闻已久的“语音支付”。</span>
                                        </dd>
                                    </dl>
                                </li>
                            </a>
                            <a href="p_new3.html">
                                <li>
                                    <dl>
                                        ...
                                        <dd>
                                            <h2>当游戏遇上金融，虚拟金融时代来临？</h2>
                                            <span>近几年，P2P、网贷、金融理财红极一时，直到去年股灾，金融热度才有所下跌。目前中国经济稍有回暖，金融业似乎又要开启新一波攻势。</span>
                                        </dd>
                                    </dl>
                                </li>
                            </a>
...
<form action="<?php echo url('vvoff/login/check'); ?>" method="post" class="code_login">
    ...
    <!--短信登录-->
    <form action="<?php echo url('vvoff/login/cnlogon'); ?>" method="post" class="code_login_d">
        <a href="javascript:void(0)">
        ...
        <div class="phone_m">
            ...
            <div class="phone_n">
                <input class="phone_nk sjh sjyzm" type="text" name="username" id="zh_03" value="" autocomplete="off" placeholder="请输入手机号"/>
            </div>
            <p class="sjgs" style="text-align: center;">*手机号码格式不正确*</p>
            <div class="phone_n shangyi">
                <input class="phone_nk" type="password" name="password" id="" value="" autocomplete="off" placeholder="请输入验证码"/>
        ...
        <div class="team_t">
            ...
            <div class="col-lg-12 col-md-12 msg">
                ...
                <div class="terrace_show">
                    <dl>
                        <dt>
                            <img src="<?php echo '/mall/'.$v['headimg']?>"/>
                            <span>
        <h4>个人简介</h4>
                ...
                <ul class="se_ul">
                    ...
                    <a href="<?php echo url('vvoff/index/news', ['id'=>$v['id']]); ?>">
                        <li>
                            <dl>
                                <dt>
                                    <img src="<?php echo '/mall/'.$v['art_img']?>" alt="" />
                                </dt>
                                <dd>
