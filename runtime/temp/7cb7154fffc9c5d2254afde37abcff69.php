<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:54:"F:\wamp\www\jingo/wstmart/home\view\default\carts.html";i:1500602786;s:53:"F:\wamp\www\jingo/wstmart/home\view\default\base.html";i:1497261098;s:59:"F:\wamp\www\jingo/wstmart/home\view\default\header_top.html";i:1499654586;s:59:"F:\wamp\www\jingo/wstmart/home\view\default\shop_apply.html";i:1489135872;s:65:"F:\wamp\www\jingo/wstmart/home\view\default\self_shop_header.html";i:1498444974;s:55:"F:\wamp\www\jingo/wstmart/home\view\default\header.html";i:1499654722;s:55:"F:\wamp\www\jingo/wstmart/home\view\default\footer.html";i:1497249046;}*/ ?>
<!doctype html>
<head>
...
<div class="wst-container">
    ...
    <div class='cart-box'>
       ...
       <?php if(!empty($carts["carts"])): if(is_array($carts["carts"]) || $carts["carts"] instanceof \think\Collection): $i = 0; $__LIST__ = $carts["carts"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	       <div class='cart-item'>
	          <div class='shop'>
	          <input type='checkbox' class='j-chk j-ch' onclick='checkChks(this,".j-s<?php echo $vo['shopId']; ?>")'><span><?php echo $vo['shopName']; ?></span>
	          <?php if($vo['shopWangWang'] !=''): ?>
	          ...
	          <div class='goods-list'>
	             ...
	             <div class='item j-chk <?php if($vo2["isCheck"]==1): ?>selected<?php endif; ?> j-s<?php echo $vo['shopId']; ?> j-g<?php echo $vo2["cartId"]; ?>'>
			        ...
			        <div class='t-price'>¥<span id="tprice_<?php echo $vo2['cartId']; ?>" class="dj"><?php echo $vo2['shopPrice']*$vo2['cartNum']; ?></span></div>
	       ...
	       <div class='cart-footer selected2'>
	          <div class='cart-summary'>
	             <div class='summary'>应付总金额(不含运费)：¥<span id='totalMoney'><?php echo $carts["goodsTotalMoney"]; ?></span><a href='#none' onclick='toSettlement()' class='wst-next wst-cart-reda'>结算</a></div>
