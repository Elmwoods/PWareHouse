<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:63:"/mnt/data/www/wstmart/home/view/default/articles/news_view.html";i:1490002660;s:49:"/mnt/data/www/wstmart/home/view/default/base.html";i:1490282008;s:55:"/mnt/data/www/wstmart/home/view/default/header_top.html";i:1489733602;s:55:"/mnt/data/www/wstmart/home/view/default/shop_apply.html";i:1489135872;s:61:"/mnt/data/www/wstmart/home/view/default/self_shop_header.html";i:1488332796;s:51:"/mnt/data/www/wstmart/home/view/default/header.html";i:1490953514;s:51:"/mnt/data/www/wstmart/home/view/default/footer.html";i:1489648028;}*/ ?>
<!doctype html>
<head>
...
<div class="bc-nav">
	<p>
		...
		<?php if(is_array($bcNav) || $bcNav instanceof \think\Collection): $i = 0; $__LIST__ = $bcNav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bc): $mod = ($i % 2 );++$i;?>
...
<div class="help-box">
	<div class="help-left">
		...
		<ul id="parent">
            ...
            <li class="h-cat h-show">
                ...
                <ul class="h-list">
                	<?php if(is_array($v['children']) || $v['children'] instanceof \think\Collection): $k1 = 0; $__LIST__ = $v['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($k1 % 2 );++$k1;?>
	...
	<div class="help-right">
		<div class="h-content">
			...
			<ul class="news-list">
				<?php if(is_array($index) || $index instanceof \think\Collection): $i = 0; $__LIST__ = $index;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?>
