<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"E:\wamp64\wamp\www\mall/wstmart/vvadmin\view\staff\dolist.html";i:1495096558;s:61:"E:\wamp64\wamp\www\mall/wstmart/vvadmin\view\index\index.html";i:1495099634;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="mainbar">
				...
				<!-- Page heading -->
				<div class="page-head">
					<h2 class="pull-left"><i class="icon-list-alt"></i>职员管理</h2>

					<!-- Breadcrumb -->
					<div class="bread-crumb pull-right">
						<a href=""><i class="icon-list-alt"></i>职员列表</a>
						<!-- Divider -->
						<span class="divider">/</span>
						<a href="<?php echo url('add')?>" class="bread-current">添加职员</a>
					</div>
                  ...
                  <div class="padd">
                        <table class='table table-bordered table-hover' >
                             ...
                             <tr>
                                ...
                                <td><?php echo $v['motto']?></td>
                                <td><?php echo $v['introduction']?></td>
                                <td><?php echo $v['addtime']?></td>
                                <td><?php echo $v['headimg']?></td>
