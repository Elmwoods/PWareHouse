<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"/mnt/data/www/wstmart/vvadmin/view/staff/add.html";i:1495096550;s:51:"/mnt/data/www/wstmart/vvadmin/view/index/index.html";i:1495716001;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="mainbar">
				...
				<!-- Page heading -->
				<div class="page-head">
					<h2 class="pull-left"><i class="icon-list-alt"></i>职员添加</h2>

					<!-- Breadcrumb -->
					<div class="bread-crumb pull-right">
						<a href="<?php echo url('Staff/dolist'); ?>"><i class="icon-list-alt"></i>职员列表</a>
						<!-- Divider -->
						<span class="divider">/</span>
						<a href="#" class="bread-current">职员添加</a>
					</div>
              ...
              <div class="widget wgreen">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal"  action="<?php echo url('Staff/doadd'); ?>" method="post" id="staffadd" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input class="form-control" placeholder="" type="text" name="motto">
                                  </div>
                                 </div>
                                 <div class="form-group">
                                  <label class="col-lg-4 control-label">个人简介</label>
                                  <div class="col-lg-8">
                                    <textarea  name="introduction" id="introduction" cols="135" rows="10"></textarea>
                                  </div>
                                 </div>
                                <div class="form-group">
